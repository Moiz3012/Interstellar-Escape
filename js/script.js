...
function crewFunc() {
  ...
  crewNav1.onclick = function () {
    crewImage.src = "image-douglas-hurley.webp";
  ...
  crewNav2.onclick = function () {
    crewImage.src = "image-mark-shuttleworth.webp";
  ...
  crewNav3.onclick = function () {
    crewImage.src = "image-victor-glover.webp";
  ...
  crewNav4.onclick = function () {
    crewImage.src = "image-anousheh-ansari.webp";
...
function changeImg1() {
  if (sWidth >= 1280) {
    tecImage.style.backgroundImage = "url(image-launch-vehicle-portrait.jpg)";
  } else if (sWidth >= 768) {
    tecImage.style.backgroundImage = "url(image-launch-vehicle-landscape.jpg)";
  } else if (sWidth >= 375) {
    tecImage.style.backgroundImage = "url(image-launch-vehicle-landscape.jpg)";
  }
...
function changeImg2() {
  if (sWidth >= 1280) {
    tecImage.style.backgroundImage = "url(image-spaceport-portrait.jpg)";
  } else if (sWidth >= 768) {
    tecImage.style.backgroundImage = "url(image-spaceport-landscape.jpg)";
  } else if (sWidth >= 375) {
    tecImage.style.backgroundImage = "url(image-spaceport-landscape.jpg)";
  }
...
function changeImg3() {
  if (sWidth >= 1280) {
    tecImage.style.backgroundImage = "url(image-space-capsule-portrait.jpg)";
  } else if (sWidth >= 768) {
    tecImage.style.backgroundImage = "url(image-space-capsule-landscape.jpg)";
  } else if (sWidth >= 375) {
    tecImage.style.backgroundImage = "url(image-space-capsule-landscape.jpg)";
  }
